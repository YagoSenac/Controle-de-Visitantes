    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('AGUARDANDO', 'Aguardando Autorização'), ('EM VISITA', 'Em visita'), ('Finalizado', 'Visita Finalizada')], default='AGUARDANDO', max_length=10, verbose_name='status')),
                ...
                ('horario_saida', models.DateTimeField(blank=True, null=True, verbose_name='Horário de saida do condominio')),
